...
export function BrowseVisualArtists({ onArtistClick, onBack }) {
  ...
  return (
    <div>
      ...
      >
        <h2 className="text-3xl md:text-4xl tracking-tight mb-3 md:mb-4">visual artists</h2>
        <p className="text-gray-400 tracking-wide text-sm md:text-base">
          {visualArtists.length} artists sharing their work
        </p>
      </motion.div>
      ...
      {visualArtists.length === 0 && (
        ...
        >
          <p className="text-gray-400 text-base md:text-lg">no visual artists available yet</p>
            ...
            >
              ...
              <div className="flex items-center gap-3 md:gap-4 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm text-gray-400">{artist.artworkCount} works</p>
                </div>
              </div>
